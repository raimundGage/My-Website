      ...
      >
        ...
        <div className="bg-win-blue mb-2 px-2 py-1 flex justify-between items-center">
          ...
          <div className="flex gap-1">  
            <button className="bg-win-grey border-[1.25px] border-l-win-light border-t-win-light border-r-black border-b-black px-1 text-xs font-bold leading-none">?</button>
            <button className="bg-win-grey border-[1.25px] border-l-win-light border-t-win-light border-r-black border-b-black px-1 text-xs font-bold leading-none">-</button>
            <button className="bg-win-grey border-[1.25px] border-l-win-light border-t-win-light border-r-black border-b-black px-1 text-xs font-bold leading-none">X</button>
          </div>
        </div>
